...
public class ArmorDialogFragment35 extends DialogFragment {
    ...
    ArmorDialogFragment35.NoticeDialogListener mListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.fesrbtn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onDialogPositiveClick(ArmorDialogFragment35.this);
            }
        });
        view.findViewById(R.id.fesrbtn_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onDialogNegativeClick(ArmorDialogFragment35.this);
            }
        });
        ...
        ((TextView) view.findViewById(R.id.fitv_total)).setText("" + (10 + m_dex + m_bonus + m_armor + m_shield));
        dex.setText("" + m_dex);
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            mListener = (ArmorDialogFragment35.NoticeDialogListener) context;
    ...
    public interface NoticeDialogListener {
        void onDialogPositiveClick(ArmorDialogFragment35 dialog);

        void onDialogNegativeClick(ArmorDialogFragment35 dialog);
    }
}
