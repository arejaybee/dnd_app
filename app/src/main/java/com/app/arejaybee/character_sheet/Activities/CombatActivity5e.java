...
import com.app.arejaybee.character_sheet.DialogFragments.ArmorDialogFragment5e;
import com.app.arejaybee.character_sheet.DialogFragments.CombatSaveDialogFragment5e;
import com.app.arejaybee.character_sheet.DialogFragments.InitiativeDialogFragment;
import com.app.arejaybee.character_sheet.R;

import java.util.ArrayList;

public class CombatActivity5e extends AbstractCharacterActivity implements InitiativeDialogFragment.NoticeDialogListener, ArmorDialogFragment5e.NoticeDialogListener, CombatSaveDialogFragment5e.NoticeDialogListener {
    ...
    private void buildSaveLayout() {
        TextView tvStr = findViewById(R.id.c5etv_strsave);
        TextView tvDex = findViewById(R.id.c5etv_dexsave);
        TextView tvCon = findViewById(R.id.c5etv_consave);
        TextView tvInt = findViewById(R.id.c5etv_intsave);
        TextView tvWis = findViewById(R.id.c5etv_wissave);
        TextView tvCha = findViewById(R.id.c5etv_chasave);

        tvStr.setText("" + (rob.getSave("STR").getTotal() + rob.getProficiency(rob.getSave("STR").getProficiency().ordinal())));
        ...
        tvInt.setText("" + (rob.getSave("INT").getTotal() + rob.getProficiency(rob.getSave("INT").getProficiency().ordinal())));
        tvWis.setText("" + (rob.getSave("WIS").getTotal() + rob.getProficiency(rob.getSave("WIS").getProficiency().ordinal())));
        tvCha.setText("" + (rob.getSave("CHA").getTotal() + rob.getProficiency(rob.getSave("CHA").getProficiency().ordinal())));


        EditText etConditional = findViewById(R.id.c5eet_conditionalSaves);
        etConditional.setText("" + rob.getConditionalSavingThrowMods());
        addSaveClickeListener(tvStr, "STR");
        addSaveClickeListener(tvDex, "DEX");
        addSaveClickeListener(tvCon, "CON");
        addSaveClickeListener(tvInt, "INT");
        addSaveClickeListener(tvWis, "WIS");
        addSaveClickeListener(tvCha, "CHA");
    ...
    private void addSaveClickeListener(View v, String saveName) {
        v.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                CombatSaveDialogFragment5e ecsDialog = new CombatSaveDialogFragment5e();
                Bundle b = new Bundle();
                ...
                b.putSerializable("prof", rob.getSave(saveName).getProficiency().ordinal());
    ...
    private void buildStatLayout() {
        TextView tvInitiative = findViewById(R.id.c5etv_initiative);
        EditText eSpeed = findViewById(R.id.c5etv_speed);
        EditText etProficiency = findViewById(R.id.c5eet_proficiency);
        TextView tvAC = findViewById(R.id.c5etv_ac);
        EditText etCurHp = findViewById(R.id.c5eet_curHP);
        EditText etMaxHp = findViewById(R.id.c5eet_maxHP);

        eSpeed.setText("" + rob.getSpeed());
        tvInitiative.setText("" + (rob.getDexMod() + rob.getInitiativeBonus()));
        tvAC.setText("" + (rob.getArmorClass().getMod() + rob.getDexMod()));
        etProficiency.setText("" + rob.getProficiency());
        ...
        etProficiency.addTextChangedListener(tw);
    ...
    private void buildAttackLayout() {
        ...
        LinearLayout ll = findViewById(R.id.c5ell_weaponLayout);
    ...
    public void onClickToggleSaves(View v) {
        toggleViewVisibility(v, findViewById(R.id.c5ell_saveLayout));
    }
    ...
    public void onClickArmor(View v) {
        ArmorDialogFragment5e ecsDialog = new ArmorDialogFragment5e();
        Bundle b = new Bundle();
    ...
    protected void updatePlayerFields() {
        rob.setConditionalSavingThrowMods(getTextFromView(R.id.c5eet_conditionalSaves));
        rob.setMaxHp(getIntFromView(R.id.c5eet_maxHP));
        rob.setCurrentHp(getIntFromView(R.id.c5eet_curHP));
        rob.setProficiency(getIntFromView(R.id.c5eet_proficiency));
        rob.setSpeed(getTextFromView(R.id.c5etv_speed));
        rob.saveCharacter(this);
        TextView tvStr = findViewById(R.id.c5etv_strsave);
        TextView tvDex = findViewById(R.id.c5etv_dexsave);
        TextView tvCon = findViewById(R.id.c5etv_consave);
    ...
    public void onDialogPositiveClick(ArmorDialogFragment5e df) {
    ...
    public void onDialogNegativeClick(ArmorDialogFragment5e df) {
        df.getDialog().cancel();
    }

    public void onDialogPositiveClick(CombatSaveDialogFragment5e df) {
    ...
    public void onDialogNegativeClick(CombatSaveDialogFragment5e df) {
        df.getDialog().cancel();
    }
}
