...
public class EditClassSkillRanksDialogFragment extends DialogFragment {
    ...
    EditClassSkillRanksDialogFragment.NoticeDialogListener mListener;
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.fesrbtn_save).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                mListener.onDialogPositiveClick(EditClassSkillRanksDialogFragment.this);
            }
        });
        view.findViewById(R.id.fesrbtn_cancel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                mListener.onDialogNegativeClick(EditClassSkillRanksDialogFragment.this);
            }
        });
    ...
    public void onAttach(Context context) {
        ...
        try {
            ...
            mListener = (EditClassSkillRanksDialogFragment.NoticeDialogListener) context;
    ...
    public interface NoticeDialogListener {
        void onDialogPositiveClick(EditClassSkillRanksDialogFragment dialog);

        void onDialogNegativeClick(EditClassSkillRanksDialogFragment dialog);
    }
}
